...
<div class="card">
    <div class="card-body">
        <div class="d-flex align-content-center justify-content-between mb-3">
            ...
            <div class="d-flex">
                <a href="/kategori/create" class="btn btn-primary me-2">
                ...
                <a href="/kategori-export" class="btn btn-secondary">
            ...
            <div class="card card-body">
                <form action="/kategori-import" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <p class="mt-2"><a href="/imports/data_kategori.xlsx">Download Template</a></p>
                    </div>
        ...
        <table class="table table-striped table-bordered">
            <thead>
              <tr>
                <th scope="col">#</th>
                <th scope="col">
    <a href="?sort_name=nama&sort_val={{$sort}}">kategori
            ...
            <tbody>
              @foreach ($data as $key=>$item)
                  <tr>
                    ...
                    <td>
                        <a class="btn btn-warning btn-sm" href="/kategori/{{$item->id}}">
                            <span data-feather="eye"></span>
                        </a>
                        <a class="btn btn-primary btn-sm" href="/kategori/{{$item->id}}/edit">
                            <span data-feather="edit"></span>
                        </a>

                        <a class="btn btn-danger btn-sm" href="javascript:" onclick="deleteData({{$item->id}})"><span data-feather="trash"></span></a>
                        <form class="d-none" id="formdelete-{{$item->id}}" action="/kategori/{{$item->id}}" method="POST">
                            @method('DELETE')
                            @csrf
                        </form>
                    </td>
