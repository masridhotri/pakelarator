...
<div class="card">
    <div class="card-body">
        ...
        <form method="POST" class="" action="/buku/{{$data->id}}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="mb-3">
...
<div class="mb-3">
    ...
    <input type="text" name="kategori" value="{{$data->kategori}}"
        class="form-control @error('kategori') is-invalid @enderror" id="inputkategori"
...
<div class="mb-3">
    ...
    <input type="text" name="foto" value="{{$data->foto}}"
        class="form-control @error('foto') is-invalid @enderror" id="inputfoto"
...
<div class="mb-3">
    ...
    <input type="text" name="stok" value="{{$data->stok}}"
        class="form-control @error('stok') is-invalid @enderror" id="inputstok"
        aria-describedby="stokHelp">
    @error('stok')
    <div class="invalid-feedback">
        {{ $message }}
    </div>
